...
module HighScores =
    ...
    let update (msg: HighScoreMsg) (state: HighScoreState) =
        match msg with
        | OpenUrl link ->
            let url =
                match link with
    ...
    let avaloniaLinksView (dock: Dock) (dispatch: HighScoreMsg -> unit) : IView =
        StackPanel.create
            [ StackPanel.dock dock
    ...
    let avaloniaFuncUILinksView (dock: Dock) (dispatch: HighScoreMsg -> unit) : IView =
        StackPanel.create
            [ StackPanel.dock dock
    ...
    let view (state: HighScoreState) (dispatch: HighScoreMsg -> unit) =
        DockPanel.create
